	           ...
	           <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	               	<ul class="nav navbar-nav">
	                   	...
	                   	<%if(session.getAttribute("user_id") == null) { %>
		                   	<li>
		                    	<a href="user/user_login.jsp">LOGIN</a>
		                   	</li>
		                   	<li>
		                       	<a href="user/user_join.jsp" style="color:red">JOIN</a>
	                   		</li>
                   		<%}else{ %>
                   			<li>
	                    	<a href="user/user_logout.jsp">LOGOUT</a>
		                   	</li>
		                   	<li>
		                       	<a href="user/user_mypage.jsp" style="color:red">MYPage</a>
	                   		</li>
                   		<%} %>
               		</ul>
       			</div>
