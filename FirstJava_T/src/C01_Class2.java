...
public class C01_Class2 {
	...
	public static void main(String[] args) {
		...
		// 맴버 초기화 생성자를 통한 instance 객체 생성
		Pen pen2 = new Pen("blue");
		System.out.println(pen2);
		System.out.println("펜의 색상은 '" + pen1.color + "' 입니다.");
		...
		System.out.println("팬의 색상은 '" + pen4.color + "' 입니다.");
		System.out.println("팬의 가격은 '" + pen4.getPrice() + "'원 입니다.");
		
		
//		Pen pen5 = new Pen("skyblue",10,1500);
//		System.out.println(pen5);
//		System.out.println("팬의 색상은 '" + pen5.color + "' 입니다.");
//		System.out.println("팬의 길이은 '" + pen5.length + "cm' 입니다.");
//		System.out.println("팬의 가격은 '" + pen5.getPrice() + "'원 입니다.");
