...
public class E10_compareEx2 {
	...
	public static void main(String[] args) {
		...
		gym.add(new GymMember("설영우", 1002));
		gym.add(new GymMember("황희찬", 1003));
		gym.add(new GymMember("박찬호", 1004));
		gym.add(new GymMember("조현우", 1005));
		gym.add(new GymMember("이강인", 1006));
		...
		gym2.add(new GymMember("설영우", 1002));
		gym2.add(new GymMember("황희찬", 1003));
		gym2.add(new GymMember("박찬호", 1004));
		gym2.add(new GymMember("조현우", 1005));
		gym2.add(new GymMember("이강인", 1006));
...
class GymMember implements Comparable<GymMember> {
	...
	public int compareTo(GymMember o) {
		...
		//  - 현재 인스턴스와 o의 자리를 그대로 유지하고 싶을 때는 -1을 리턴합니다.
