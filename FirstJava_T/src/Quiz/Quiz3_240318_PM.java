...
class LandAnimal {	// 육지동물
	void run() {
		System.out.println("육지 동물은 뛸 수 있습니다.");
	}
}

class MarineAnimal {	// 해양동물
	void run() {
...
class Dog extends LandAnimal implements Animal, Pet {	// 개
	@Override
	public void sleep() {
...
class Goldfish extends MarineAnimal implements Animal {	// 금붕어
	@Override
	public void sleep() {
...
class Tiger extends LandAnimal implements Animal {	// 호랑이
...
class Shark extends LandAnimal implements Animal {	// 상어
