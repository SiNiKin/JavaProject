...
public class H03_ThreadEx2 {
	 ...
	 * 				IntertuptedException처리를 강제하기 때문에 try구문 사용
	 * 	- interrupt() : 스레드가 일시 정지 상태에 있을 때에 IntertuptedException예외발생
	 * 					run()메서드가 정상 종료 시킬 수 있게 한다. 
...
//					}
		...
		t1.interrupt();		// 스레드가 일시정지 상태이면 예외 발생.  sleep interrupted
