 ...
 * 	- static 제한자는 지정된 변수와 메서드를 인스턴스와 무관하게 만들어 주기 때문에 this 가질 수 없음.
 * 	- static 메서드는 non-static 메서드로 재정의 될 수 없음.
 * 	- 변수
 * 	  > 정적변수, 여러개의 인스턴스가 모두 동일한 장소를 참조.
 * 	  > final과 같이 사용되어 상수가 된.
 * 	  > 객체 생성 없이 참고가능
 *  - 메서드
 ...
 *  - static
 *    > 형식은 static {} 형태
 *    > 클래스가 로딩 될 때 딱 한번만 외출, 생성자 호출되기 전에...
 * 
 */
...
public class C06_static_init {
	...
	public static void main(String[] args) {
		...
		InstanceInit il = new InstanceInit();
		System.out.println(il.DATA);
